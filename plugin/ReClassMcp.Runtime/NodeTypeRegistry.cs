...
namespace ReClassMcp.Runtime
{
    ...
    internal static class NodeTypeRegistry
    {
        ...
        {
            Register<Int8Node>("int8", "Int8", "i8", "char");
            Register<Int16Node>("int16", "Int16", "i16", "short");
            Register<Int32Node>("int32", "Int32", "i32", "int");
            Register<Int64Node>("int64", "Int64", "i64", "long");
            Register<UInt8Node>("uint8", "UInt8", "u8", "byte");
            Register<UInt16Node>("uint16", "UInt16", "u16", "word");
            Register<UInt32Node>("uint32", "UInt32", "u32", "dword");
            Register<UInt64Node>("uint64", "UInt64", "u64", "qword");
            Register<FloatNode>("float", "Float", "f32", "float32");
            Register<DoubleNode>("double", "Double", "f64", "float64");

            Register<Hex8Node>("hex8", "Hex8", "hexbyte");
            Register<Hex16Node>("hex16", "Hex16", "hexword");
            Register<Hex32Node>("hex32", "Hex32", "hexdword");
            Register<Hex64Node>("hex64", "Hex64", "hexqword");

            Register<BoolNode>("bool", "Bool");
            Register<BitFieldNode>("bitfield", "BitField");
            Register<EnumNode>("enum", "Enum");

            Register<Vector2Node>("vector2", "Vector2", "vec2");
            Register<Vector3Node>("vector3", "Vector3", "vec3");
            Register<Vector4Node>("vector4", "Vector4", "vec4");
            Register<Matrix3x3Node>("matrix3x3", "Matrix3x3");
            Register<Matrix3x4Node>("matrix3x4", "Matrix3x4");
            Register<Matrix4x4Node>("matrix4x4", "Matrix4x4", "mat4x4");

            Register<Utf8TextNode>("utf8text", "Utf8Text", "string", "utf8");
            Register<Utf8TextPtrNode>("utf8textptr", "Utf8TextPtr", "stringptr", "utf8ptr");
            Register<Utf16TextNode>("utf16text", "Utf16Text", "wstring", "utf16");
            Register<Utf16TextPtrNode>("utf16textptr", "Utf16TextPtr", "wstringptr", "utf16ptr");
            Register<Utf32TextNode>("utf32text", "Utf32Text");
            Register<Utf32TextPtrNode>("utf32textptr", "Utf32TextPtr");

            Register<PointerNode>("pointer", "Pointer", "ptr", "uintptr", "void*");
